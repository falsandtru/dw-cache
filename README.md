...
const data = {
  ...
  datasets: [
    ...
    {
      label: 'DWC',
      data: [14.54, 28.17, 39.47, 44.27, 50.12, 56.95, 63.28, 70.16],
...
TRC hit ratio 10.47%
DWC hit ratio 14.54%
DWC - LRU hit ratio delta 11.45%

DS1 2,000,000
LRU hit ratio 10.74%
TRC hit ratio 22.78%
DWC hit ratio 28.17%
DWC - LRU hit ratio delta 17.43%

DS1 3,000,000
LRU hit ratio 18.59%
TRC hit ratio 34.45%
DWC hit ratio 39.47%
DWC - LRU hit ratio delta 20.88%

DS1 4,000,000
LRU hit ratio 20.24%
TRC hit ratio 39.68%
DWC hit ratio 44.27%
DWC - LRU hit ratio delta 24.02%

DS1 5,000,000
LRU hit ratio 21.03%
TRC hit ratio 46.69%
DWC hit ratio 50.12%
DWC - LRU hit ratio delta 29.09%

DS1 6,000,000
LRU hit ratio 33.95%
TRC hit ratio 53.64%
DWC hit ratio 56.95%
DWC - LRU hit ratio delta 23.00%

DS1 7,000,000
LRU hit ratio 38.89%
TRC hit ratio 61.28%
DWC hit ratio 63.28%
DWC - LRU hit ratio delta 24.38%

DS1 8,000,000
LRU hit ratio 43.03%
TRC hit ratio 68.93%
DWC hit ratio 70.16%
DWC - LRU hit ratio delta 27.12%
```
...
const data = {
  ...
  datasets: [
    ...
    {
      label: 'DWC',
      data: [10.17, 19.24, 27.78, 37.44, 40.97, 46.82, 55.77, 64.03],
      borderColor: Utils.color(2),
    },
    {
      label: 'TrueLRU',
...
![image](https://github.com/falsandtru/dw-cache/assets/3143368/e703cb2b-8d03-4e89-930e-e4748ed0b3a4)
...
TRC hit ratio 23.85%
DWC hit ratio 27.78%
DWC - LRU hit ratio delta 20.19%

S3 400,000
LRU hit ratio 12.03%
TRC hit ratio 31.94%
DWC hit ratio 37.44%
DWC - LRU hit ratio delta 25.40%

S3 500,000
LRU hit ratio 22.76%
TRC hit ratio 40.35%
DWC hit ratio 40.97%
DWC - LRU hit ratio delta 18.20%
...
const data = {
  ...
  datasets: [
    ...
    {
      label: 'DWC',
      data: [19.40, 29.48, 34.90, 37.98, 40.01, 41.88, 43.46, 44.69],
      borderColor: Utils.color(2),
    },
    {
      label: 'TrueLRU',
...
![image](https://github.com/falsandtru/dw-cache/assets/3143368/068a431c-fa1c-4022-8f0b-f9caa71b1546)
...
TRC hit ratio 27.86%
DWC hit ratio 29.48%
DWC - LRU hit ratio delta 6.04%

OLTP 750
LRU hit ratio 28.28%
TRC hit ratio 33.11%
DWC hit ratio 34.90%
DWC - LRU hit ratio delta 6.61%
...
TRC hit ratio 38.88%
DWC hit ratio 40.01%
DWC - LRU hit ratio delta 3.80%

OLTP 1,500
LRU hit ratio 38.69%
TRC hit ratio 40.79%
DWC hit ratio 41.88%
DWC - LRU hit ratio delta 3.19%
...
const data = {
  ...
  datasets: [
    ...
    {
      label: 'DWC',
      data: [15.37, 31.31, 41.55, 49.25, 52.79, 53.54, 55.60, 57.96],
      borderColor: Utils.color(2),
    },
    {
      label: 'TrueLRU',
...
![image](https://github.com/falsandtru/dw-cache/assets/3143368/e1ff6952-be48-4f8a-a604-3b165d867a02)
...
TRC hit ratio 47.24%
DWC hit ratio 49.25%
DWC - LRU hit ratio delta 38.03%

GLI 1,250
LRU hit ratio 21.25%
TRC hit ratio 52.04%
DWC hit ratio 52.79%
DWC - LRU hit ratio delta 31.53%
...
TRC hit ratio 0.00%
DWC hit ratio 8.01%
DWC - LRU hit ratio delta 8.01%

LOOP 250
LRU hit ratio 0.00%
TRC hit ratio 0.00%
DWC hit ratio 21.53%
DWC - LRU hit ratio delta 21.53%

LOOP 500
LRU hit ratio 0.00%
TRC hit ratio 0.00%
DWC hit ratio 44.44%
DWC - LRU hit ratio delta 44.44%

LOOP 750
LRU hit ratio 0.00%
TRC hit ratio 0.00%
DWC hit ratio 67.78%
DWC - LRU hit ratio delta 67.78%

LOOP 1,000
LRU hit ratio 0.00%
TRC hit ratio 0.00%
DWC hit ratio 96.61%
DWC - LRU hit ratio delta 96.61%
...
TRC hit ratio 35.88%
DWC hit ratio 34.36%
DWC - LRU hit ratio delta 12.76%

WS1 5,000,000
LRU hit ratio 33.91%
TRC hit ratio 44.19%
DWC hit ratio 40.09%
DWC - LRU hit ratio delta 6.18%
...
TRC hit ratio 34.04%
DWC hit ratio 33.80%
DWC - LRU hit ratio delta 1.62%

F1 10,000
LRU hit ratio 33.27%
TRC hit ratio 35.57%
DWC hit ratio 35.45%
DWC - LRU hit ratio delta 2.18%

F1 12,500
LRU hit ratio 34.19%
TRC hit ratio 36.72%
DWC hit ratio 36.65%
DWC - LRU hit ratio delta 2.46%
