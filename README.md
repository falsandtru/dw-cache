...
const data = {
  ...
  datasets: [
    ...
    {
      label: 'DWC',
      data: [19.36, 27.92, 33.54, 37.52, 39.63, 41.40, 43.00, 44.27],
      borderColor: Utils.color(2),
    },
    {
      label: 'LIRS',
...
LRU hit ratio 0.00%
DWC hit ratio 46.02%
DWC - LRU hit ratio delta 46.02%
DWC / LRU hit ratio rate  Infinity%

LOOP 750
LRU hit ratio 0.00%
DWC hit ratio 71.40%
DWC - LRU hit ratio delta 71.40%
DWC / LRU hit ratio rate  Infinity%

LOOP 1,000
LRU hit ratio 0.00%
DWC hit ratio 96.94%
DWC - LRU hit ratio delta 96.94%
DWC / LRU hit ratio rate  Infinity%
